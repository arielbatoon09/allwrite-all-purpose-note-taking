...
<body class="dashboard-body">
                    ...
                    <div class="dashboard-inner-wrap">
                        <div class="container py-100">
                            ...
                            <div class="dashboard-content">
                                <a href="./resources.php" class="href-link ms-2" id="btn-back">
                                ...
                                <div class="dashboard-content-wrap mt-4">
                                    <div class="dashboard-content-new" id="dashboard-content-list">
                                        <div class="mb-3 d-flex flex-column">
                                            ...
                                            <input class="title form-control" id="title" placeholder="Algebra Basics: What Is Algebra? - Math Antics">                                        
                                        </div>
                                        <div class="mb-3 d-flex flex-column">
    ...
    <script src="../../middleware/addResources.js"></script>
</body>
